...
export const AppContextProvider = ({ children }) => {
    ...
    function loadGoogleCookies() {
        ...
        })(window,document,"script","dataLayer","GTM-TZ3ZC9X6");

        // Google Analytics #1
        const gaScript1 = document.createElement("script");
        gaScript1.async = true;
        gaScript1.src = "https://www.googletagmanager.com/gtag/js?id=G-M6NPDKKB5Q";
        ...
        gaScript1.onload = function() {
            ...
            gtag("js", new Date());
            gtag("config", "G-M6NPDKKB5Q");
        };

        // Google Analytics #2
        const gaScript2 = document.createElement("script");
        gaScript2.async = true;
        gaScript2.src = "https://www.googletagmanager.com/gtag/js?id=G-M6NPDKKB5Q";
